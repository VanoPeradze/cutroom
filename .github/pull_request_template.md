...
Describe the problem and the resulting behavior. Link the relevant issue, if any.

## Verification

List the checks you ran and their results. Explain anything you could not test. For interface changes, include screenshots using synthetic or non-sensitive content.

## Review checklist

- [ ] The change is focused, and relevant documentation is updated.
- [ ] I checked the affected behavior and added a regression test where appropriate.
